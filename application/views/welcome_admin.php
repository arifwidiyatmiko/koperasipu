                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Dashboard Koperasi</h2>
                                        ...
                                        <div class="au-task-list js-scrollbar3">
                                            <div class="au-task__item au-task__item--danger">
                                                <div class="au-task__item-inner">
                                                    <h5 class="task">
                                                        <a href="<?php echo base_url();?>assets/#">Meeting about plan for Admin Template 2018</a>
                                                    </h5>
                                            ...
                                            <div class="au-task__item au-task__item--warning">
                                                <div class="au-task__item-inner">
                                                    <h5 class="task">
                                                        <a href="<?php echo base_url();?>assets/#">Create new task for Dashboard</a>
                                                    </h5>
                                        ...
                                        <div class="au-chat">
                                            <div class="au-chat__title">
                                                <div class="au-chat-info">
                                                    ...
                                                    <span class="nick">
                                                        <a href="<?php echo base_url();?>assets/#">John Smith</a>
                                                    </span>
                                                </div>
                                            </div>
