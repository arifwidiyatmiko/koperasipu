                                                    ...
                                                    <table style="margin-left: -140px;
                                                        ...
                                                        <tr style="font-size: 20px">
                                                            ...
                                                            <td style=" text-align: center;
                                                                                                ...
                                                                                                border-radius: 10px;
                                                                                                border-collapse: separate; ">
                                                            <?= terbilang($kwitansi->jasa)?> Rupiah</td>
                                                        </tr>
                                                        <tr rowspan="4" style=" vertical-align: top; font-size: 20px;">
                                                            <td style="">Untuk pembayaran</td>
                                                            <td>:</td>
                                                            <td >
                                                                <table style=" width: 100%; font-size: 20px">
                                                                    <tr>
                                                                        <td>Pinjaman kredit dengan angsuran</td>
                                                                        <td><?= rupiah($kwitansi->nominal) ?></td>
                                                                        <td>selama</td>
                                                                        <td><?= $kwitansi->jumlahBulan ?></td>
                                                                        <td>bulan</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                            ...
                                                            <td style="margin-left: 100px" align="right">
                                                                <table style="font-size: 20px">
                                                                    <tr>
                                                                        ...
                                                                        <td>&nbsp; &nbsp;</td>
                                                                        <td><?= tanggal($kwitansi->tanggal) ?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                        <tr align="center" style="font-size: 20px">
                                                            <td colspan="3">
                                                                <table style="width: 100%; table-layout: fixed; font-size: 20;"> 
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                    <td align="center" style="font-size: 20px"><br><br><br>Misbahudin, S.Sos.</td>
                                                                    <td align="center" style="font-size: 20px"><br><br><br>Tatang Suryana</td>
                                                                    <td align="center" style="font-size: 20px"><br><br><br><?= $this->session->userdata('users_koperasi')->namaLengkap; ?> </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <table style="font-size: 20px">
                                                                    <tr style="font-size: 20px">
                                                                        ...
                                                                        <td align="center" style=" text-align: center;
                                                                                                ...
                                                                                                font-size: 20px;
                                                                                                border-radius: 10px;
                                                                                                border-collapse: separate; "><?= rupiah($kwitansi->jasa) ?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
