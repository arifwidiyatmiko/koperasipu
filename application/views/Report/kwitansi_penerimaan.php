                                                ...
                                                <div class="col-9" style="">
                                                    <table style="margin-left: -140px;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>:</td>
                                                            <td>KPRI P3U TASIKMALAYA</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Banyaknya uang</td>
                                                            <td>:</td>
                                                            <td><?= terbilang($kwitansi->nominal)?> Rupiah</td>
                                                        </tr>
                                                        <tr rowspan="4" style=" vertical-align: top;">
                                                            <td style="">Untuk pembayaran</td>
                                                            <td>:</td>
                                                            <td>Pinjaman Kredit dengan angsuran <?= $kwitansi->jumlahBulan?> x bayar / bulan</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Mengetahui</td>
                                                            <td>:</td>
                                                        ...
                                                        <tr align="center">
                                                            <td colspan="3">
                                                                <table style="width: 100%; table-layout: fixed; "> 
                                                                    ...
                                                                    <td align="center" style=""><br><br><br><br><?= $kwitansi->namaLengkap?> <br> No Anggota <?= $kwitansi->idUser?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td align="center" style=" text-align: center;
                                                                                                ...
                                                                                                vertical-align: center;"><?= rupiah($kwitansi->nominal)?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
