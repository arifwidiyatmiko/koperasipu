                                                ...
                                                <div class="col-9" style="">
                                                    <table style="margin-left: -140px;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>:</td>
                                                            <td><?= terbilang($kwitansi->jumlahBulan) ?></td>
                                                        </tr>
                                                            ...
                                                            <td >
                                                                <table style=" width: 100%">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?= $kwitansi->sisaPeminjaman?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Kekurangan Jasa</td>
                                                                        <td><?= $kwitansi->jasa?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                                ...
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td align="center" style=" text-align: center;
                                                                                                ...
                                                                                                vertical-align: center;"><?php 
                                                                                                    $total = $kwitansi->sisaPeminjaman + $kwitansi->jasa;
                                                                                                    echo $total;
                                                                                                ?></td>
                                                                    </tr>
                                                                </table>
